        ...
        <div class="py-4">
            ...
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    ...
                    <p class="mb-0">Form untuk mengedit data buku.</p>
                </div>
                <div>
        ...
        <div class="row">
            <div class="col-12 mb-4">
                <div class="card border-0 shadow components-section">
                    <div class="card-body">
                        <form action="{{ route('.update', $dataPelanggan->pelanggan_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-4">
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $dataBuku->judul_buku }}" type="text" id="judul_buku" name="judul_buku" class="form-control" required>
                                    </div>

                                    <!-- Penulis -->
                                    <div class="mb-3">
                                        <label for="penulis" class="form-label">Penulis</label>
                                        <input value="{{ $dataBuku->penulis }}" type="text" id="penulis" name="penulis" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ $dataBuku->penerbit }}" type="text" id="penerbit" name="penerbit" class="form-control" required>
                                    </div>
