...
<body class="index-page sidebar-collapse"><div id="ofBar"><div id="ofBar-logo"> <img alt="creative-tim-logo" src="https://s3.amazonaws.com/creativetim_bucket/static-assets/logo-ct-black.png"></div><div id="ofBar-content">🔥 Be Strong in 2025: <b>Unlock the All-Access Pass – 80% OFF</b>! ❤️ Don't Miss Out!</div><div id="ofBar-right"><a href="https://www.creative-tim.com/campaign?ref=ct-demos" target="_blank" id="btn-bar">View Offer</a><a id="close-bar">×</a></div></div>
        ...
        <div id="buttons" class="cd-section">
          ...
          <div class="row">
            <div class="col-md-8 mx-auto">
              <button class="btn btn-primary">Default<div class="ripple-container"></div></button>
              <button class="btn btn-primary btn-round">Round<div class="ripple-container"></div></button>
              ...
              <div class="ripple-container"></div></button>
              <button class="btn btn-primary btn-link">Simple<div class="ripple-container"></div></button>
            </div>
          </div>
          <div class="title">
          ...
          <div class="row">
            <div class="col-md-8 mx-auto">
              <button class="btn btn-primary btn-sm">Small<div class="ripple-container"></div></button>
          ...
          <div class="row">
            <div class="col-md-10 ml-auto">
              ...
              <button class="btn btn-info">Info<div class="ripple-container"></div></button>
              <button class="btn btn-success">Success<div class="ripple-container"></div></button>
              <button class="btn btn-warning">Warning</button>
              <button class="btn btn-danger">Danger<div class="ripple-container"></div></button>
              <button class="btn btn-rose">Rose<div class="ripple-container"></div></button>
            </div>
          </div>
        </div>
        <!--                 end buttons		         -->
        ...
        <div id="sliders">
          <div class="row">
            <div class="col-md-6">
              ...
              <div id="sliderRegular" class="slider noUi-target noUi-ltr noUi-horizontal noUi-txt-dir-ltr"><div class="noUi-base"><div class="noUi-connects"><div class="noUi-connect" style="transform: translate(0%, 0px) scale(0.4, 1);"></div></div><div class="noUi-origin" style="transform: translate(-600%, 0px); z-index: 4;"><div class="noUi-handle noUi-handle-lower" data-handle="0" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="0.0" aria-valuemax="100.0" aria-valuenow="40.0" aria-valuetext="40.00"><div class="noUi-touch-area"></div></div></div></div></div>
              <div id="sliderDouble" class="slider slider-info noUi-target noUi-ltr noUi-horizontal noUi-txt-dir-ltr"><div class="noUi-base"><div class="noUi-connects"><div class="noUi-connect" style="transform: translate(20%, 0px) scale(0.4, 1);"></div></div><div class="noUi-origin" style="transform: translate(-800%, 0px); z-index: 5;"><div class="noUi-handle noUi-handle-lower" data-handle="0" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="0.0" aria-valuemax="60.0" aria-valuenow="20.0" aria-valuetext="20.00"><div class="noUi-touch-area"></div></div></div><div class="noUi-origin" style="transform: translate(-400%, 0px); z-index: 4;"><div class="noUi-handle noUi-handle-upper" data-handle="1" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="20.0" aria-valuemax="100.0" aria-valuenow="60.0" aria-valuetext="60.00"><div class="noUi-touch-area"></div></div></div></div></div>
            </div>
            ...
            <nav class="navbar navbar-expand-lg bg-info">
              <div class="container">
                ...
                <div class="collapse navbar-collapse">
                  <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                      <a href="javascript:;" class="nav-link"><i class="material-icons">email</i></a>
                    </li>
                    <li class="nav-item">
                      <a href="javascript:;" class="nav-link"><i class="material-icons">face</i></a>
                    </li>
                    <li class="dropdown nav-item">
              ...
              <div class="collapse navbar-collapse">
                <ul class="navbar-nav">
                  <li class="nav-item active">
                    <a href="javascript:;" class="nav-link">link</a>
                  </li>
                  <li class="nav-item">
                    <a href="javascript:;" class="nav-link">link</a>
                  </li>
          ...
          <nav class="navbar navbar-transparent navbar-expand-lg">
            <div class="container">
              <div class="navbar-translate">
                ...
                <button type="button" class="ml-auto navbar-toggler" data-toggle="collapse" data-target="#example-navbar-transparent" aria-expanded="true">
                  <span class="sr-only">Toggle navigation</span>
                  <span class="navbar-toggler-icon"></span>
                  <span class="navbar-toggler-icon"></span>
                  <span class="navbar-toggler-icon"></span>
              ...
              <div class="navbar-collapse collapse show" id="example-navbar-transparent" style="">
                <ul class="navbar-nav ml-auto">
                  <li class="nav-item">
                    <a href="javascript:;" class="nav-link">
                      <i class="fa fa-facebook-square"></i>
      ...
      <div class="container">
        ...
        <div class="row" id="modals">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group bmd-form-group is-filled">
                    ...
                    <input type="text" class="form-control datetimepicker" value="03/06/2020">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <button type="button" class="btn" data-toggle="popover" data-placement="left" title="" data-content="Here will be some very useful information about his popover. Here will be some very useful information about his popover." data-container="body" data-original-title="Popover on left">On left</button>
            <button type="button" class="btn" data-toggle="popover" data-placement="top" title="" data-content="Here will be some very useful information about his popover." data-container="body" data-original-title="Popover on top">On top</button>
            <button type="button" class="btn" data-toggle="popover" data-placement="bottom" title="" data-content="Here will be some very useful information about his popover." data-container="body" data-original-title="Popover on bottom">On bottom</button>
            <button type="button" class="btn" data-toggle="popover" data-placement="right" title="" data-content="Here will be some very useful information about his popover." data-container="body" data-original-title="Popover on right">On right</button>
            <br><br>
            <div class="title">
              <h3>Tooltips</h3>
            </div>
            <button type="button" class="btn" data-toggle="tooltip" data-placement="left" title="" data-container="body" data-original-title="Tooltip on left">On left</button>
  ...
  <footer class="footer" data-background-color="black">
    <div class="container">
      ...
      <div class="copyright float-right">
        ...
        </script>2025, made with <i class="material-icons">favorite</i> by
  ...
  <script src="./assets/js/core/popper.min.js" type="text/javascript"></script><style>
  #ofBar {
    background: #fff;
    z-index: 999999999;
    font-size: 16px;
...
<script defer="" src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon="{&quot;rayId&quot;:&quot;99670be38c949f92&quot;,&quot;serverTiming&quot;:{&quot;name&quot;:{&quot;cfExtPri&quot;:true,&quot;cfEdge&quot;:true,&quot;cfOrigin&quot;:true,&quot;cfL4&quot;:true,&quot;cfSpeedBrain&quot;:true,&quot;cfCacheStatus&quot;:true}},&quot;version&quot;:&quot;2025.9.1&quot;,&quot;token&quot;:&quot;1b7cbb72744b40c580f8633c6b62637e&quot;}" crossorigin="anonymous"></script>
